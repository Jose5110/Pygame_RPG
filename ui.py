...
class UI:
	def __init__(self):
		...
		# weapon graphics list
		self.weapon_graphics = self.import_overlay_graphics(weapon_data)

		# magic graphics list
		self.magic_graphics = self.import_overlay_graphics(magic_data)

	def import_overlay_graphics(self, data):
		graphics_list = []
