...
class Player(Entity):
	def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
		...
		self.image = pygame.image.load(join('.','assets','graphics','test','player.png'))
		...
		# Stats
		self.original_stats = {'health': 100, 'energy':60, 'attack': 10, 'magic': 4, 'speed': 5}
		...
		# sounds
		self.weapon_attack_sound = pygame.mixer.Sound(join('.','assets','audio','sword.wav'))
		self.weapon_attack_sound.set_volume(0.1)

	def import_player_assets(self):
		character_path = join('.','assets','graphics','player')
